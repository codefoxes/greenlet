...
class Customizer {
	...
	public function enqueue_preview_scripts() {
		...
		wp_enqueue_script( 'greenlet-preview', LIBRARY_URL . '/backend/assets/js/greenlet-preview' . $min . '.js', array( 'jquery', 'react-dom', 'customize-preview' ), GREENLET_VERSION, true );
