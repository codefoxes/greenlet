...
(function (React$1) {
  ...
  var initialState = {
    isCw: false,
    // Is Colorwings panel expanded
    mounted: true,
    // Is Colorwings preview component mounted
  ...
  function toggleMediaEditor() {
    ...
    if (null === cwmNode) {
      ...
      var preview = document.getElementById('customize-preview');
      preview.insertAdjacentElement('afterend', cwmNode); // preview.parentNode.insertBefore(cwmNode, preview.nextSibling);
  ...
  function togglePreviewOverlay() {
    var op = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'disable';
    cwoNode = document.getElementById('cw-preview-overlay');

    if (null === cwoNode) {
      cwoNode = document.createElement('div');
      cwoNode.id = 'cw-preview-overlay';
      var preview = document.getElementById('customize-preview');
      preview.appendChild(cwoNode);
      ReactDOM.render( /*#__PURE__*/React.createElement("div", null, "Overlay"), cwoNode);
    }

    if (op === 'enable') {
      document.documentElement.classList.add('cwo-enabled');
    } else {
      document.documentElement.classList.remove('cwo-enabled');
    }
  }
  ...
  var toggleMounted = function toggleMounted() {
    ...
    if (mount === true) {
      ...
      togglePreviewOverlay('enable');
      !mounted && MainStore.setMounted(true);
    } else {
      cw.Evt.emit('unmount-colorwings');
      toggleMediaEditor('disable');
      togglePreviewOverlay('disable');
      !!mounted && MainStore.setMounted(false);
    }
  };
  var setCw = function setCw() {
    var isCw = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    toggleMounted(isCw);
    MainStore.setCw(isCw);
  };
  ...
  var enableShortcuts = function enableShortcuts() {
    ...
    var preview = document.getElementById('customize-preview');
    preview.firstChild.contentWindow.document.addEventListener('keydown', listenShortcuts, false); // Todo: Performance: Passive !! false !!
  ...
  var disableShortcuts = function disableShortcuts() {
    ...
    var preview = document.getElementById('customize-preview');
    preview.firstChild.contentWindow.document.removeEventListener('keydown', listenShortcuts, false); // Todo: Performance: Passive !! false !!
  ...
  function Color(props) {
    ...
    var pickNative = function pickNative(e) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "cw-npicker-label"
    }, /*#__PURE__*/React.createElement("span", {
      className: "dashicons dashicons-color-picker"
    }), /*#__PURE__*/React.createElement("input", {
      type: "color",
      className: "cw-npicker",
      onChange: pickNative
    }))), /*#__PURE__*/React.createElement(Tooltip, {
      text: "Clear Color",
      position: "top right"
  ...
  function Select(props) {
    ...
    var renderCustomOption = function renderCustomOption(domProps, option, snapshot, className) {
      return /*#__PURE__*/React.createElement(Tooltip, {
        text: option.name,
        position: "top left"
      }, /*#__PURE__*/React.createElement("button", _extends({}, domProps, {
        className: className,
        type: "button"
  ...
  StylesStore.subscribe(function () {
    if (cm === false) return; // Todo: Debounce the Update
  ...
  function Footer() {
    var _useStore = useStore(MainStore, 'isCw'),
        isCw = _useStore.isCw;
    ...
    })))), isCw && /*#__PURE__*/React.createElement("style", null, '.collapse-sidebar-label { display: none !important }'));
  }
  ...
  function Panel() {
    ...
    }, /*#__PURE__*/React.createElement(Settings, null))), /*#__PURE__*/React.createElement(Footer, null));
  }
