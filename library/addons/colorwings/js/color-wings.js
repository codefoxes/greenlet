...
(function (React$1) {
  ...
  var initialState$2 = {
    ...
    settings: {
      ...
      palettes: [{
        name: 'Default',
        colors: ['#23b887', '#00A28F', '#2F4858', '#f5f5f5', '#999999', '#3273dc', '#FF794F'],
        visible: true
      }]
    },
    currentColor: '#ffffff'
  ...
  var MainStoreClass = /*#__PURE__*/function (_Store) {
    function MainStoreClass() {
      ...
      return _callSuper(this, MainStoreClass, arguments);
    }
    _inherits(MainStoreClass, _Store);
    return _createClass(MainStoreClass, [{
      key: "setMounted",
      ...
      value: function addInitialSettings(settings) {
        if (!settings) return;
        this.set(function () {
          return _objectSpread2({}, settings);
        });
      }
    }, {
      key: "changePage",
      value: function changePage(currentPage, currentPageType) {
        ...
        localStorage.setItem('cwCurrentPage', currentPage);
      }
    }, {
      ...
      value: function addFont(font) {
        this.set(function (_ref) {
          ...
          if (source in allFonts[currentPage]) {
            ...
            allFonts[currentPage][source] = _defineProperty$6({}, family, [weight]);
          }
          return {
            allFonts: allFonts
          };
      ...
      key: "setCurrentColor",
      value: function setCurrentColor(currentColor) {
        this.set(function () {
          return {
  ...
  var MainStore = new MainStoreClass(initialState$2);
  ...
  var MediaClass = /*#__PURE__*/function (_Store) {
    function MediaClass() {
      ...
      return _callSuper(this, MediaClass, arguments);
    }
    _inherits(MediaClass, _Store);
    return _createClass(MediaClass, [{
  ...
  var StylesClass = /*#__PURE__*/function (_Store) {
    function StylesClass() {
      ...
      return _callSuper(this, StylesClass, arguments);
    }
    _inherits(StylesClass, _Store);
    return _createClass(StylesClass, [{
      key: "set",
      value: function set(state, info) {
        var _this = this;
        _superPropGet(StylesClass, "set", this, 3)([function (prev) {
          var _clone = clone(prev),
            styles = _clone.styles,
            allOutputs = _clone.allOutputs;
          var count = _this.historyCount || 100;
          if (Object.keys(allOutputs).length === 0) return state(prev);
      ...
      value: function addInitialStyle(styles, settings) {
        ...
        this.overrideInitialState(_objectSpread2(_objectSpread2({}, initialState), {}, {
          styles: parsedStyles,
          allOutputs: allOutputs
        }));
      ...
      value: function parseStyles(cssString) {
        var _getStylesFromRules = function getStylesFromRules(rules) {
          ...
          rules.forEach(function (rule) {
            if (rule.type === 'rule') {
              ...
              styles[rule.media] = _getStylesFromRules(rule.rules, rule.media)[rule.media];
            }
          });
          return styles;
        };
        try {
          ...
          return _getStylesFromRules(parsed.stylesheet.rules);
        } catch (e) {
          return e;
        }
      }
      ...
      value: function undo() {
        ...
        _superPropGet(StylesClass, "set", this, 3)([function () {
          future.push({
            styles: styles,
            allOutputs: allOutputs
          });
  ...
  var StylesStore = new StylesClass(initialState);
  ...
  function resetResizer() {
    ...
    setTimeout(function () {
      ...
      resizePreview(preview.clientWidth);
    }, 500);
  }
  ...
  var styles$2 = "#color-wings-media{display:none;position:absolute;top:0;left:0;right:0;height:100%}#color-wings-media *{box-sizing:border-box}.cwm-enabled #color-wings-media{display:block}.cwm-enabled #customize-preview{height:calc(100% - 24px);top:24px;left:0;margin:auto 0 auto 1px}.cwm-enabled #customize-preview iframe{z-index:2}.cwm-bar{position:fixed;top:0;left:301px;right:0;height:24px;background:#444;color:#eee;border-bottom:1px solid #555;z-index:5}@media screen and (min-width: 1667px){.cwm-bar{left:calc(18% + 1px)}}.collapsed .cwm-bar{left:1px !important}.cwm-resizer{position:absolute;top:24px;left:100%;height:calc(100% - 24px);width:14px;background:#666;cursor:ew-resize;z-index:3}.cwm-resizer:before{content:\"\";width:2px;height:26px;top:50%;position:absolute;left:50%;transform:translate(-50%, -50%);border-right:2px solid #888;border-left:2px solid #888}.cwm-resizing #color-wings-media{z-index:3}.cwm-resizing #customize-preview{transition:none !important}.cwm-resizer-tip{position:absolute;top:0;left:0}.cwm-indicator{position:absolute;bottom:0;left:0;height:26px;width:0;border-top:1px solid #eee;border-right:1px solid rgba(0,0,0,0);border-bottom:1px solid rgba(0,0,0,0);border-left:1px solid var(--accent)}#cwm-resizer-details{position:absolute;top:2px;color:#fff;left:16px;background:#444;padding:0 10px}.cwm-breakpoint-adder{position:absolute;background:#eee;border:1px solid #666;color:#000;left:0;top:0;padding:0 5px 0 5px;border-radius:0 0 3px 0;max-height:18px;white-space:nowrap;cursor:pointer;z-index:5;border-top-width:0;line-height:16px}.cwm-breakpoint-adder:before,.cwm-breakpoint-adder:after{content:\"\";display:block;position:absolute;left:0;top:100%;width:0;height:0;border-top:6px solid #eee;border-right:8px solid rgba(0,0,0,0);border-bottom:0 solid rgba(0,0,0,0);border-left:0 solid rgba(0,0,0,0)}.cwm-breakpoint-adder:before{left:-1px;border-top:8px solid #666;border-right:11px solid rgba(0,0,0,0);border-bottom:0 solid rgba(0,0,0,0);border-left:0 solid rgba(0,0,0,0)}.cwm-breakpoint-adder .plus-sign{font-size:18px}.cwm-breakpoint-adder .adder-text{display:none}.cwm-breakpoint-adder:hover .adder-text{display:block}.cwm-breakpoint-adder:hover .plus-sign{display:none}.cwm-resizing .cwm-breakpoint-adder{display:none}.cwm-queries,.cwm-breakpoints{position:absolute;top:0;left:0;width:100%;height:100%}.cwm-breakpoints{height:0}.cwm-breakpoint{position:absolute;height:24px;width:10px;cursor:pointer;transform:translateX(-50%)}.cwm-breakpoint:before{content:\"\";position:absolute;left:50%;height:100%;width:1px;background:var(--accent)}.cwm-query{position:absolute;height:30%;line-height:24px;color:#444;cursor:pointer;display:none}.cwm-query.enabled{color:#fff;display:block}.cwm-bar.expanded .cwm-queries{height:250px;background:#fff;box-shadow:0 0 100px 50px #000}.cwm-bar.expanded .cwm-query{display:block;height:24px;border-radius:3px}.cwm-bar.expanded .cwm-query:not(.active) .cwm-query-enabler{display:block}.cwm-bar.expanded .cwm-query-details{display:block}.cwm-bar-toggler{position:absolute;right:0;background:var(--accent);cursor:pointer}.cwm-bar-toggler .dashicons{line-height:24px;height:24px;width:24px;transform:rotateZ(90deg)}.cwm-query-enabler{position:absolute;font-size:14px;line-height:24px;height:24px;padding:0 6px;width:max-content;background:rgba(0,0,0,.1);border-radius:3px;display:none}.cwm-query-enabler:hover{background:rgba(0,0,0,.2)}.cwm-query-details{font-size:12px;white-space:nowrap;padding-left:34px;display:none}.cwm-query-details:hover{background:var(--accent);color:#fff}.cwm-query.active{height:24px}.cwm-query.active .cwm-query-details{display:block;padding-left:8px}.cwm-context-bg{position:fixed;left:0;top:0;height:100%;width:100%}.cwm-context-menu{position:fixed;padding:4px 0 5px;background:rgba(239,239,239,.95);box-shadow:0 4px 9px rgba(0,0,0,.34);border-radius:4px;color:#000}.cwm-context-item{padding:1px 20px;cursor:default}.cwm-context-item:hover{background:#4195fa;color:#fff}";
  ...
  function toggleMediaEditor() {
    ...
    if (null === cwmNode) {
      ...
      var preview = document.getElementById('customize-preview');
      preview.insertAdjacentElement('afterend', cwmNode);
      // preview.parentNode.insertBefore(cwmNode, preview.nextSibling);
      ReactDOM.render(/*#__PURE__*/React.createElement(Canvas$1, null), cwmNode);
    }
    if (op === 'enable') {
      cwmState = 'open';
  ...
  var sendUpdateControlEvent = function sendUpdateControlEvent() {
    ...
    currentStylesDetails[currentTheme]['settings'] = settings;
  ...
  var addInitialStyles = function addInitialStyles(api) {
    ...
    var savedPage = localStorage.getItem('cwCurrentPage');
    var current;
    var currentPage = 'global';
    if (savedPage !== null && savedPage in themeStyles) {
      current = themeStyles[savedPage];
      currentPage = savedPage;
    } else if ('global' in themeStyles) {
    ...
    var allFonts = {};
    for (var page in themeStyles) {
      if (!themeStyles.hasOwnProperty(page)) {
        continue;
      }
      if ('fonts' in themeStyles[page]) {
        allFonts[page] = themeStyles[page].fonts;
      }
    }
    var settings = 'settings' in themeStyles ? themeStyles['settings'] : MainStore.get().settings;
    MainStore.addInitialSettings({
      allFonts: allFonts,
      currentPage: currentPage,
  ...
  var scale = 1;
  var cwSettings = MainStore.get().settings;
  var listenShortcuts = function listenShortcuts(e) {
    ...
    if (e.metaKey || e.ctrlKey) {
      if (e.key === 's') {
        ...
        e.preventDefault();
        StylesStore.redo();
      } else if ((e.key === '+' || e.key === '-' || e.key === '0') && e.shiftKey) {
        e.preventDefault();
        var frm = document.getElementById('customize-preview').firstChild;
        scale = Math.floor(frm.getBoundingClientRect().width * 10 / frm.offsetWidth) / 10;
        if (e.key === '0') {
          scale = 1;
          frm.style.transform = 'scale(1)';
        } else {
          frm.style.transform = "scale(".concat(scale + .2 * (e.key === '+' ? 1 : -1), ")");
        }
      }
    }
  };
  var zoom = function zoom(e) {
    if (e.deltaY % 1 === 0 && !e.ctrlKey) return;
    e.preventDefault();
    var prvw = document.getElementById('customize-preview');
    var pFrm = prvw.firstChild;
    scale += e.deltaY * -0.01;
    scale = Math.min(Math.max(.25, scale), 8);
    pFrm.style.transform = "scale(".concat(scale, ")");
    prvw.scrollTo({
      top: e.pageY * scale - e.clientY,
      left: e.pageX * scale - e.clientX,
      behavior: 'auto'
    });
  };
  ...
  var enableShortcuts = function enableShortcuts() {
    ...
    var preview = document.getElementById('customize-preview');
    preview.firstChild.contentWindow.document.addEventListener('keydown', listenShortcuts, false);
    // Todo: Performance: Passive !! false !!
    preview.firstChild.contentWindow.document.addEventListener('wheel', zoom, {
      passive: false
    });
    preview.style.backgroundColor = '#191e23';
  };
  var disableShortcuts = function disableShortcuts() {
    document.removeEventListener('keydown', listenShortcuts, false);
    var preview = document.getElementById('customize-preview');
    preview.firstChild.contentWindow.document.removeEventListener('keydown', listenShortcuts, false);
    // Todo: Performance: Passive !! false !!
    preview.firstChild.contentWindow.document.removeEventListener('wheel', zoom, {
      passive: false
    });
  ...
  var setCurrent = function setCurrent(data) {
    ...
    var currentStyles = window.getComputedStyle(currentTarget);
  ...
  function Length(props) {
    ...
    if (showShortHand) {
      tabContent = [0, 1, 2, 3, 4].map(function (i) {
        return /*#__PURE__*/React.createElement(LengthTab, _extends$1({}, props, {
          values: values,
          key: i,
          tab: i,
          hidden: i !== state.tab,
      ...
      tabContent = /*#__PURE__*/React.createElement(LengthTab, _extends$1({}, props, {
        handleChange: handleChange
      }));
    }
  ...
  function LengthTab(props) {
    ...
    var _getLength = getLength(),
      ...
      main = _getLength2[0],
      unit = _getLength2[1];
    if (props.units === undefined && unit in units) {
      units[unit] = _objectSpread2(_objectSpread2({}, units[unit]), {}, {
        max: units[unit].step * 100
      });
    }
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        '--min': state.min,
        '--max': state.max,
        '--val': state.main ? state.main : (state.max - state.min + 0.01) / 2
      },
  ...
  function ColorPalette(props) {
    var _useStore = useStore(MainStore, 'settings'),
      settings = _useStore.settings;
    var extra = {
      palettes: settings.palettes,
      swatches: []
    };
    var changeCol = function changeCol(e) {
      props.setColor(e.currentTarget.style.backgroundColor);
    };
    var changePaletteName = function changePaletteName(p, val) {
      var newSettings = clone(settings);
      newSettings.palettes[p].name = val;
      cw.Evt.emit('update-settings', newSettings);
    };
    var changeVisibility = function changeVisibility(p) {
      var newSettings = clone(settings);
      newSettings.palettes[p].visible = !newSettings.palettes[p].visible;
      cw.Evt.emit('update-settings', newSettings);
    };
    var addPalette = function addPalette() {
      var newSettings = clone(settings);
      newSettings.palettes.push({
        name: 'Name',
        colors: [],
        visible: true
      });
    ...
    var addCol = function addCol(p) {
      var newSettings = clone(settings);
      newSettings.palettes[p].colors.push(MainStore.get().currentColor);
      cw.Evt.emit('update-settings', newSettings);
    };
    var deletePalette = function deletePalette(p) {
      var newSettings = clone(settings);
      newSettings.palettes.splice(p, 1);
      cw.Evt.emit('update-settings', newSettings);
    };
    var deleteCol = function deleteCol(p, c) {
      var newSettings = clone(settings);
      newSettings.palettes[p].colors.splice(c, 1);
      cw.Evt.emit('update-settings', newSettings);
    };
    var _React$useState = React.useState({
        editing: false,
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      type: "button",
      className: "cw-toggle cw-edit-toggle",
      onClick: toggleEdit
    }, /*#__PURE__*/React.createElement("span", {
      className: "dashicons dashicons-admin-generic"
    })))), /*#__PURE__*/React.createElement("div", {
      className: "cw-coloration".concat(!state.editing ? ' active' : '')
    }, !state.swatch ? /*#__PURE__*/React.createElement("div", {
      className: "cw-color-palettes"
    }, extra.palettes.map(function (palette, p) {
      if (palette.visible) {
        return /*#__PURE__*/React.createElement("div", {
          key: palette.name,
          className: "cw-color-palette"
        }, /*#__PURE__*/React.createElement("div", {
          className: "cw-colors"
      ...
      className: "cw-swatches"
    }, /*#__PURE__*/React.createElement("div", {
      className: "swatch-rows"
    }, cols.map(function (col, h) {
      return /*#__PURE__*/React.createElement("div", {
        key: h,
        className: "swatch-row"
      }, col.map(function (color) {
        return /*#__PURE__*/React.createElement("button", {
          key: color,
          title: color,
          type: "button",
      ...
      className: "cw-color-advanced".concat(state.editing ? ' active' : '')
    }, /*#__PURE__*/React.createElement("div", {
      className: "cw-color-palettes"
    }, extra.palettes.map(function (palette, p) {
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "cw-palette-header"
      }, /*#__PURE__*/React.createElement("input", {
        type: "text",
        className: "cw-palette-name",
        value: palette.name,
        onChange: function onChange(e) {
          return changePaletteName(p, e.target.value);
        }
      }), /*#__PURE__*/React.createElement(Tooltip, {
        text: palette.visible ? 'Hide this palette' : 'Show this palette',
        position: "top left"
      }, /*#__PURE__*/React.createElement("button", {
        type: "button",
        className: "cw-palette-toggle",
        onClick: function onClick() {
          return changeVisibility(p);
        }
      }, /*#__PURE__*/React.createElement("span", {
        className: "dashicons dashicons-".concat(palette.visible ? 'visibility' : 'hidden')
      }))), /*#__PURE__*/React.createElement(Tooltip, {
        text: "Delete this palette",
        position: "top left"
      }, /*#__PURE__*/React.createElement("button", {
        type: "button",
        className: "cw-palette-delete",
        onClick: function onClick() {
          return deletePalette(p);
        }
      }, /*#__PURE__*/React.createElement("span", {
        className: "dashicons dashicons-trash"
      })))), /*#__PURE__*/React.createElement("div", {
        className: "cw-colors"
      }, palette.colors.map(function (color, c) {
        return /*#__PURE__*/React.createElement("button", {
          key: color,
          type: "button",
          style: {
  ...
  function handlePickerPosition(cp) {
    var holder = cp.getElementsByClassName('cw-color-holder')[0];
    if (!cp.classList.contains('fixed')) {
      holder.style.left = "-".concat(cp.getBoundingClientRect().left - 12, "px");
      cp.classList.add('fixed');
    }
    cp.style.height = "".concat(holder.offsetHeight + 5, "px");
  }

  // Todo: Performance: Updating MainStore re-renders entire editor rather than "Color" component. Performance hit.
  var debouncedSetCurrent = debounce(function (v) {
    return MainStore.setCurrentColor(v);
  }, 500);
  function Color(props) {
    props.type && 'background' === props.type ? 'background' : 'color';
    ...
    var setColor = function setColor(val) {
      props.onChange(val);
      debouncedSetCurrent(val);
    };
    var changeCol = function changeCol(val) {
      return setColor(val.color.toRgbString());
    };
    ...
    // Todo: Performance: Gradient Picker is re rendering on Color Change. Check React Profiler and change color continuously.
    ...
    options.forEach((option, index) => {
      if ('type' in option && option.type === 'group') {
        ...
        option.items.forEach(groupOption => {
          nextOptions.push(_objectSpread$5(_objectSpread$5({}, groupOption), {}, {
            groupId: id,
      ...
      nextOptions.push(_objectSpread$5(_objectSpread$5({}, option), {}, {
        _id: "" + option.value,
        index
      }));
    });
  ...
  function groupOptions(options) {
    ...
    options.forEach((option, i) => {
      if ('groupId' in option) {
        const nextOption = _objectSpread$4({}, option);
  ...
  function fuzzySearch(value, options, fuseOptions) {
    ...
    return fuse.search(value).map((item, index) => _objectSpread$3(_objectSpread$3({}, item), {}, {
      index
    }));
  }
  ...
  function useSelect({
    ...
    const onBlur = React$1.useCallback(() => {
      setState(oldState => _objectSpread$2(_objectSpread$2({}, oldState), {}, {
        focus: false,
        search: '',
    ...
    const setFocus = newFocus => setState(oldState => _objectSpread$2(_objectSpread$2({}, oldState), {}, {
      focus: newFocus
    }));
    ...
    const onSearch = ({
      ...
      setState(oldState => _objectSpread$2(_objectSpread$2({}, oldState), newState));
      ...
      }).catch(() => setState(oldState => _objectSpread$2(_objectSpread$2({}, oldState), {}, {
        flat: flatDefaultOptions,
        searching: false
      })));
    };
    ...
    return [{
      ...
      search: search$1,
      searching
    }, valueProps, optionProps, newValue => setState(oldState => _objectSpread$2(_objectSpread$2({}, oldState), {}, {
      value: newValue
    }))];
  }
  ...
  PropTypes.oneOfType([option, PropTypes.shape({
    name: PropTypes.string.isRequired,
  ...
  const Option$1 = (_ref) => {
    ...
    const domProps = _objectSpread$1(_objectSpread$1({}, optionProps), {}, {
      value: option.value,
  ...
  const SelectSearch = /*#__PURE__*/React$1.forwardRef(({
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      const rendered = items.map(o => /*#__PURE__*/React__default["default"].createElement(Option$2, _extends({
        key: o.value,
  ...
  function Select(props) {
    ...
    var renderCustomOption = function renderCustomOption(domProps, option, snapshot, className) {
      return /*#__PURE__*/React.createElement(Tooltip, {
        text: option.name,
        position: "top left"
      }, /*#__PURE__*/React.createElement("button", _extends$1({}, domProps, {
        className: className,
        type: "button"
      }), 'clsName' in option && /*#__PURE__*/React.createElement("span", {
        className: option.clsName
      }), 'content' in option && /*#__PURE__*/React.createElement(option.content, null)));
    };
    var forwardProps = {
    ...
    if (_typeof(options[0]) === 'object' && ('clsName' in options[0] || 'content' in options[0])) {
      forwardProps['renderOption'] = renderCustomOption;
    }
  ...
  function Shadow(props) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "cw-control-content shadow"
    }, props.label && /*#__PURE__*/React.createElement("span", {
      className: "cw-control-title"
    }, props.label), /*#__PURE__*/React.createElement("span", {
      className: "cw-control-title"
  ...
  var styles$1 = "﻿:root{--accent: #23b887;--accentLight: hsl(160, 68%, 97%);--accentDark: hsl(160, 68%, 30%);--accentSec: #e8ba7d;--border: #c4c8ca;--boxShadow: 0 10px 15px rgba(0, 0, 0, 0.1), 0 0 1px 1px rgba(0, 0, 0, 0.02)}#color-wings{margin-left:-12px;margin-right:-12px}[style=\"display: none;\"]+#color-wings{margin-top:-15px}.cw-row{display:flex}.cw-row .col{flex:1}.cw-row .col-1{flex:0 0 8.3333333333%}.cw-row .col-2{flex:0 0 16.6666666667%}.cw-row .col-3{flex:0 0 25%}.cw-row .col-4{flex:0 0 33.3333333333%}.cw-row .col-5{flex:0 0 41.6666666667%}.cw-row .col-6{flex:0 0 50%}.cw-row .col-7{flex:0 0 58.3333333333%}.cw-row .col-8{flex:0 0 66.6666666667%}.cw-row .col-9{flex:0 0 75%}.cw-row .col-10{flex:0 0 83.3333333333%}.cw-row .col-11{flex:0 0 91.6666666667%}.cw-row .col-12{flex:0 0 100%}.cw-panel-heading{padding:10px;align-items:center;position:relative}.cw-panel-heading .popup-content{width:100%;box-sizing:border-box;position:absolute;z-index:5;background:#fff;right:0;border:1px solid #ccc;box-shadow:var(--boxShadow)}.cw-panel-heading .popup-overlay{position:fixed;top:0;bottom:0;left:0;right:0}.cw-panel-heading .popup-arrow{width:14px;height:14px;background:#fff;position:absolute;right:100px;top:-6px;transform:rotate(135deg);z-index:-1;box-shadow:rgba(0,0,0,.3) -1px 1px 1px}.cw-panel-heading .cw-current-page{max-height:30px;white-space:pre-wrap;overflow:auto}.cw-panel-heading .page-selector .button{border-color:rgba(0,0,0,0);background:none;padding:10px 20px}.cw-panel-heading .page-selector .button:hover{background:var(--accentLight)}.cw-panel-heading .page-selector .button:focus{border-color:#0071a1}.cw-panel-heading .cw-pause{margin:0 0 0 auto;display:block;line-height:1}.button.button-block{width:100%;text-align:center}.cw-tabs{display:flex;margin:0 -1px;position:relative;z-index:2}.cw-tabs .tab{flex:1;padding:8px;background:#ddd;border:1px solid rgba(0,0,0,0);border-bottom-color:#ccc;cursor:pointer;text-align:center}.cw-tabs .tab.active{border:1px solid #ccc;border-bottom-color:#fff;background:#fff;cursor:auto}.cw-main-tabs{display:inline-flex;width:60%}.cw-main-tabs .main-tab{color:#0071a1;outline:none}.cw-main-tabs .main-tab:focus,.cw-main-tabs .main-tab:hover{border-top:2px solid #0171a1;padding-top:7px}.cw-main-tabs .main-tab:focus:not(.active),.cw-main-tabs .main-tab:hover:not(.active){background:#f1f1f1}.cw-extra-tabs{display:inline-flex;width:calc(40% + 2px);height:36px;vertical-align:top;background:#ddd;border-top:1px solid rgba(0,0,0,0);border-bottom:1px solid #ccc;align-items:center;justify-content:flex-end}.cw-extra-tabs .disabled-element-wrapper{font-size:0}.cw-extra-tabs .button{border:none;height:100%;border-radius:0;background:none;line-height:1}.cw-extra-tabs .button:focus{box-shadow:none}.cw-extra-tabs .button:disabled,.cw-extra-tabs .button[disabled]{background:none !important}.cw-extra-tabs .button .dashicons{font-size:16px;line-height:20px}#cw-code-editor{width:100%}.cw-code-editor .CodeMirror{height:calc(100vh - 254px);margin-bottom:-24px;overflow:hidden}.cw-settings-controls{padding:24px 12px}.cw-settings-controls .components-panel,.cw-settings-controls .components-button,.cw-settings-controls .components-panel__body-title,.cw-settings-controls .components-panel__body{border-radius:4px !important;border-color:var(--border)}.cw-settings-controls .components-panel .components-button,.cw-settings-controls .components-panel__body.is-opened{padding:8px}.cw-settings-controls .components-panel svg.components-panel__arrow{right:8px;width:20px}.cw-settings-controls .components-panel__body.is-opened>.components-panel__body-title{margin:-8px -8px 5px -8px}.cw-settings-controls .components-panel .components-button:focus{box-shadow:inset 0 0 0 1.5px var(--accent)}.customize-control .cw-link-wrap{background:#fff;padding:6px 10px;cursor:pointer;border-left:2px solid rgba(0,0,0,0);transition:all .15s ease-in-out,border-color .15s ease-in-out,background .15s ease-in-out;box-shadow:0 0 0 1px #ddd;position:relative}.customize-control .cw-link-wrap:hover{color:#0073aa;background:#f3f3f5;border-left:2px solid #0073aa}.customize-control .cw-link-wrap:hover:after{color:#0073aa}.customize-control .cw-link-wrap:after{content:\"\";font:normal 16px/1 dashicons;color:#a0a5aa;position:absolute;right:6px;top:calc(50% - 8px)}.customize-control .cw-link-text{position:absolute;right:26px;top:calc(50% - 9px);font-size:11px}.cw-theming-controls{padding:12px;min-height:calc(100vh - 327px);margin-bottom:-24px;display:flex;flex-direction:column;align-items:center;justify-content:center}.cw-theming-controls .cw-control{margin-bottom:18px}.cw-theming-controls .cw-control-title{font-size:13px}.cw-theming-controls .cw-color{display:flex;align-items:center;flex-wrap:wrap}.cw-theming-controls .cw-color .cw-control-title{width:50%}.cw-theming-controls .cw-color-info{width:50%}.cw-theming-controls .cw-color-wrap{min-width:1px}.cw-theming-controls .cw-select{display:flex;margin-top:20px}.cw-theming-controls .cw-select .cw-control-title{width:66.667%}.cw-theming-controls .cw-select .select-search{width:33.333%}#customize-preview{overflow:auto}#customize-preview iframe{transform-origin:0 0}";
  ...
  function Header() {
    ...
    for (var page in allPages) {
      if (allPages.hasOwnProperty(page) && allPages[page].name.toString() === currentPage.toString()) {
  ...
  function Editor() {
    ...
    var setFontOptions = function setFontOptions() {
      ...
      fontFamily = fontFamily.replace(/^"(.+(?="$))"$/, '$1');
      var currentFontDetails = getFontDetails(fontFamily);
          ...
          options: [{
            ...
            content: function content() {
              return /*#__PURE__*/React.createElement("svg", {
                ...
                fill: "currentColor",
                d: "M1 6h4v4H1zm5 0h4v4H6zm5 0h4v4h-4z"
              }));
            }
          }, {
            name: 'Repeat Y',
            ...
            content: function content() {
              return /*#__PURE__*/React.createElement("svg", {
                ...
                fill: "currentColor",
                d: "M6 1h4v4H6zm0 5h4v4H6zm0 5h4v4H6z"
              }));
            }
          }, {
            name: 'No Repeat',
            value: 'no-repeat',
            clsName: 'dashicons dashicons-no-alt'
          }],
          val: currentStyles.backgroundRepeat,
          printOptions: 'always',
          horizontal: true
        },
        cls: 'col-6'
      ...
      controls: [{
        ...
        params: {
          ...
          options: [{
            ...
            name: 'Scroll',
            value: 'scroll',
            clsName: 'dashicons dashicons-menu-alt'
          }, {
            name: 'Auto',
            value: 'auto',
            clsName: 'dashicons dashicons-admin-generic'
          }],
          val: currentStyles.overflow,
          printOptions: 'always',
          horizontal: true
        },
        cls: 'col-7'
  ...
  function Theming() {
    ...
    var _getControls = function getControls() {
      var _StylesStore$get = StylesStore.get(),
        styles = _StylesStore$get.styles;
      var computed = [];
      Object.entries(cssVars).forEach(function (_ref) {
        ...
        if (is(val, 'color')) {
          ...
          control.params.onTab = function (tab) {
            if (tab === false) {
              setTimeout(function () {
                return updateControls(_getControls());
              });
            }
          };
  ...
  function Settings() {
    ...
    var change = function change(e) {
      ...
      if ('shortcuts' === e.target.name) {
        newSettings.shortcuts = e.target.checked;
      } else if ('history' === e.target.name) {
        newSettings.history = e.target.value;
      }
      cw.Evt.emit('update-settings', newSettings);
    };
    var cmd = navigator.platform.includes('Mac') ? 'Cmd' : 'Ctrl';
    var shortcuts = [['Undo', "".concat(cmd, " + z")], ['Redo', "".concat(cmd, " + Shift + z")], ['Redo', "".concat(cmd, " + y")], ['Save / Publish', "".concat(cmd, " + s")], ['Zoom In', "".concat(cmd, " + Shift + \u2795")], ['Zoom Out', "".concat(cmd, " + Shift + \u2796")], ['Zoom Reset', "".concat(cmd, " + Shift + 0")], ['Zoom', 'Ctrl + Mouse wheel'], ['Zoom', 'Pinch / Spread']];
    var _wp$components = wp.components,
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      ...
      className: "description customize-control-description"
    }, "Keyboard shortcuts for save, undo - redo etc."), /*#__PURE__*/React.createElement(Panel, {
      className: "cw-shortcuts-list"
      ...
      return /*#__PURE__*/React.createElement(PanelRow, {
        ...
        className: "cw-sc"
      }, sc[0]), /*#__PURE__*/React.createElement("div", {
        className: "cw-action"
      }, sc[1]));
    })))), /*#__PURE__*/React.createElement("li", {
  ...
  function Panel() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "dashicons dashicons-image-filter"
    }))), /*#__PURE__*/React.createElement(Tooltip, {
      text: "Settings",
      position: "top left"
    }, /*#__PURE__*/React.createElement("button", {
  ...
  wp.customize.controlConstructor['color-wings'] = wp.customize.Control.extend({
    ready: function ready() {
      ...
      ReactDOM.render(/*#__PURE__*/React.createElement(Canvas, null), document.getElementById('color-wings'));
